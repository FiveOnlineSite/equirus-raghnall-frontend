...
export const metadata = {
  title: "Group Cyber Insurance | Equirus Raghnall",
  description: "Tailored Group Cyber Insurance solutions.",
};

const faqs = [
  { question: "Who should consider Group Cyber Insurance?", answer: "Group Cyber Insurance can be tailored to the needs and risk profile of the insured." },
    ...
    <>
      ...
      <main>
        <ServiceHero
          ...
          imageAlt="Group Cyber Insurance"
        ...
        />
        <ServiceOverview
          label="What Is Group Cyber Insurance?"
          title="Understanding Group Cyber Insurance"
          image="/assets/services/directors-officers/overview.png"
          imageAlt="Group Cyber Insurance overview"
          description="Group Cyber Insurance is designed to manage cyber risks. Its scope can be tailored to the insured's circumstances, exposures, and expected financial impact."
        ...
        <ServiceAdvisorySupport
          ...
          imageAlt="Group Cyber Insurance advisory support"
        ...
        />
        <ServiceCta
          title="Ready To Explore Group Cyber Insurance?"
