...
const faqs = [
  { question: "Who should consider Property All Risk (PAR)?", answer: "Property All Risk (PAR) can be tailored to the needs and risk profile of the insured." },
    ...
    <>
      ...
      <main>
        ...
        <ServiceOverview
          ...
          description="Property All Risk (PAR) is designed to manage property risks. Its scope can be tailored to the insured's circumstances, exposures, and expected financial impact."
