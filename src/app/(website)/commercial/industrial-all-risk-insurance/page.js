...
const faqs = [
  { question: "Who should consider Industrial All Risk (IAR)?", answer: "Industrial All Risk (IAR) can be tailored to the needs and risk profile of the insured." },
    ...
    <>
      ...
      <main>
        ...
        <ServiceOverview
          ...
          description="Industrial All Risk (IAR) is designed to manage property risks. Its scope can be tailored to the insured's circumstances, exposures, and expected financial impact."
