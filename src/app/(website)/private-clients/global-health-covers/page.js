...
const faqs = [
  { question: "Who should consider Global Health Covers?", answer: "Global Health Covers can be tailored to the needs and risk profile of the insured." },
  ...
  return (
    <>
      ...
      <main>
        ...
        />
        <ServiceOverview
          label="What Is Global Health Covers?"
          title="Understanding Global Health Covers"
          image="/assets/services/directors-officers/overview.png"
          imageAlt="Global Health Covers overview"
          description="Global Health Covers is designed to manage pcg risks. Its scope can be tailored to the insured's circumstances, exposures, and expected financial impact."
        ...
        />
        <ServiceCta
          title="Ready To Explore Global Health Covers?"
