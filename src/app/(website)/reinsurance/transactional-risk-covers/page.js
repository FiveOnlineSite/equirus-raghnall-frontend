...
export const metadata = {
  title: "Transactional Risk Covers | Equirus Raghnall",
  description: "Tailored Transactional Risk Covers solutions.",
};

const faqs = [
  { question: "Who should consider Transactional Risk Covers?", answer: "Transactional Risk Covers can be tailored to the needs and risk profile of the insured." },
...
export default function Page() {
  return (
    <>
      ...
      <main>
        <ServiceHero
          label="Transactional Risk Covers"
          ...
          imageAlt="Transactional Risk Covers"
        ...
        />
        <ServiceOverview
          label="What Is Transactional Risk Covers?"
          title="Understanding Transactional Risk Covers"
          image="/assets/services/directors-officers/overview.png"
          imageAlt="Transactional Risk Covers overview"
          description="Transactional Risk Covers is designed to manage reinsurance risks. Its scope can be tailored to the insured's circumstances, exposures, and expected financial impact."
        ...
        <ServiceAdvisorySupport
          ...
          imageAlt="Transactional Risk Covers advisory support"
        ...
        />
        <ServiceCta
          title="Ready To Explore Transactional Risk Covers?"
