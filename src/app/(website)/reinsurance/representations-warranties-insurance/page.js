...
export const metadata = {
  title: "Representations & Warranties (R & W) | Equirus Raghnall",
  description: "Tailored Representations & Warranties (R & W) solutions.",
};

const faqs = [
  { question: "Who should consider Representations & Warranties (R & W)?", answer: "Representations & Warranties (R & W) can be tailored to the needs and risk profile of the insured." },
...
export default function Page() {
  return (
    <>
      ...
      <main>
        <ServiceHero
          label="Representations & Warranties (R & W)"
          ...
          imageAlt="Representations & Warranties (R & W)"
        ...
        />
        <ServiceOverview
          label="What Is Representations & Warranties (R & W)?"
          title="Understanding Representations & Warranties (R & W)"
          image="/assets/services/directors-officers/overview.png"
          imageAlt="Representations & Warranties (R & W) overview"
          description="Representations & Warranties (R & W) is designed to manage reinsurance risks. Its scope can be tailored to the insured's circumstances, exposures, and expected financial impact."
        ...
        <ServiceAdvisorySupport
          ...
          imageAlt="Representations & Warranties (R & W) advisory support"
        ...
        />
        <ServiceCta
          title="Ready To Explore Representations & Warranties (R & W)?"
