...
export const metadata = {
  title: "Specific Litigation Risk | Equirus Raghnall",
  description: "Tailored Specific Litigation Risk solutions.",
};

const faqs = [
  { question: "Who should consider Specific Litigation Risk?", answer: "Specific Litigation Risk can be tailored to the needs and risk profile of the insured." },
...
export default function Page() {
  return (
    <>
      ...
      <main>
        <ServiceHero
          label="Specific Litigation Risk"
          ...
          imageAlt="Specific Litigation Risk"
        ...
        />
        <ServiceOverview
          label="What Is Specific Litigation Risk?"
          title="Understanding Specific Litigation Risk"
          image="/assets/services/directors-officers/overview.png"
          imageAlt="Specific Litigation Risk overview"
          description="Specific Litigation Risk is designed to manage reinsurance risks. Its scope can be tailored to the insured's circumstances, exposures, and expected financial impact."
        ...
        <ServiceAdvisorySupport
          ...
          imageAlt="Specific Litigation Risk advisory support"
        ...
        />
        <ServiceCta
          title="Ready To Explore Specific Litigation Risk?"
