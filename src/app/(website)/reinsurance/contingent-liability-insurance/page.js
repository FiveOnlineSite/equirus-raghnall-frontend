...
export const metadata = {
  title: "Contingent Liability Insurance | Equirus Raghnall",
  description: "Tailored Contingent Liability Insurance solutions.",
};

const faqs = [
  { question: "Who should consider Contingent Liability Insurance?", answer: "Contingent Liability Insurance can be tailored to the needs and risk profile of the insured." },
...
export default function Page() {
  return (
    <>
      ...
      <main>
        <ServiceHero
          label="Contingent Liability Insurance"
          ...
          imageAlt="Contingent Liability Insurance"
        ...
        />
        <ServiceOverview
          label="What Is Contingent Liability Insurance?"
          title="Understanding Contingent Liability Insurance"
          image="/assets/services/directors-officers/overview.png"
          imageAlt="Contingent Liability Insurance overview"
          description="Contingent Liability Insurance is designed to manage reinsurance risks. Its scope can be tailored to the insured's circumstances, exposures, and expected financial impact."
        ...
        <ServiceAdvisorySupport
          ...
          imageAlt="Contingent Liability Insurance advisory support"
        ...
        />
        <ServiceCta
          title="Ready To Explore Contingent Liability Insurance?"
